...
| DataBreach.com | US / intl | Self-service + Email | `contact@databreach.com` | Confirmed opted out (both emails + username) |  |
| DeHashed | US / intl | Web form | `dehashed.com/support` | Request sent — awaiting reply |  |
| DeXpose | Intl | Email | `info@dexpose.io` | Request sent — awaiting reply |  |
| Digital Footprint Check | US / intl | Email | `info@digitalfootprintcheck.com` | Request sent — awaiting reply |  |
| Enzoic | US | Email | `info@enzoic.com` | Request sent — awaiting reply |  |
...
| GrayHatWarfare | Intl | Email | `abuse@grayhatwarfare.com` | Request sent — awaiting reply |  |
...
| HackedList.io | CZ / EU | Email | `support@hackedlist.io` | Request sent — awaiting reply | Operated by CyWeTa DNS sro |
...
| NiamonX / PwnedLookup | Intl | Email | `support@niamonx.io` | Request sent — awaiting reply |  |
| OathNet | Intl | Email | `support@oathnet.org` | Confirmed removed | Ticket TICKET-326EBA0A |
| OffSeq Breach | US / intl | Email | `breach@offseq.com` | Request sent — awaiting reply |  |
| OSINTLeak | US / intl | Self-service | `osintleak.com` | Verification code expired — resubmit |  |
...
| Site | Jurisdiction | Method | Verified contact | Outcome | Notes |
|---|---|---|---|---|---|
| AbstractAPI | US / intl | Email | `team@abstractapi.com` | Self-service — delete account in dashboard settings |  |
...
| Social Links | NL / EU | Email | `(privacy@sociallinks.io bounced)` | Bounced — no working contact |  |
| Social Searcher | US / intl | Email | `info@social-searcher.com` | No personal data stored |  |
| SynapsInt | Intl | Email | `(contact@synapsint.com bounced)` | Bounced — no working contact |  |
...
| WebMii | FR / EU | Email | `(support@webmii.com bounced)` | Bounced — no working contact |  |
...
| GetContact | TR | Email | `support@getcontact.com` | App only — getcontact.com/manage |  |
...
| Data Axle | US | Email | `(privacy@data-axle.com bounced)` | Bounced — no working contact |  |
| Dun & Bradstreet | US / intl | Email | `eudpo@dnb.com` | Request sent — awaiting reply |  |
| Ekata / Mastercard Identity | US / intl | Email | `ekataprivacyanddataprotection@mastercard.com` | Request sent — awaiting reply |  |
| Experian Marketing Services | US / intl | Email | `eu.data.privacy@experian.com` | No data held |  |
| IPQualityScore | US / intl | Email | `dpo-ipqs@smartech-it.eu` | Request sent — awaiting reply | EU Art. 27 rep in Italy |
...
| Adapt.io | US / intl | Email | `support@adapt.io` | privacy@adapt.io bounced — use support@adapt.io |  |
...
| FindThatLead | US / intl | Email | `dpo@findthatlead.com` | privacy@ bounced — use dpo@findthatlead.com |  |
| Findymail | FR / EU | Email | `privacy@findymail.com` | Does not process personal Gmail |  |
| FullContact | US / intl | Email | `privacy@fullcontact.com` | Identity verification required (Privacy Choices portal) |  |
| FullEnrich | FR / EU | Email | `support@fullenrich.com` | No records found |  |
...
| Lead411 | US | Email | `(privacy@lead411.com bounced)` | Bounced — no working contact |  |
...
| SignalHire | US / intl | Email | `support@signalhire.com` | privacy@ bounced — use support@signalhire.com |  |
| Skrapp.io | US / intl | Email | `support@skrapp.io` | Does not hold personal email addresses |  |
...
| Site | Jurisdiction | Method | Verified contact | Outcome | Notes |
|---|---|---|---|---|---|
| Bouncer | US / intl | Email | `hello@usebouncer.com` | privacy@usebouncer.com bounced |  |
...
| Emailable | US / intl | Email | `support@emailable.com` | No account found | privacy@emailable.com also used |
...
| ZeroBounce | US / intl | Email | `support@zerobounce.net` | Escalated to Tier 2 — overdue |  |
...
| AppsFlyer | IL / EU | Email | `privacy@appsflyer.com` | Wants context — B2B only |  |
...
| Kochava | US | Email | `privacy@kochava.com` | Request sent — awaiting reply |  |
...
| Lotame | US / intl | Email | `privacy@lotame.com` | Merged into Epsilon (Oct 2025) — redirected |  |
...
| The Trade Desk | US / intl | Email | `dpo@thetradedesk.com` | Auto-reply — use consumer privacy process |  |
...
| Cyberint | IL | Email | `(privacy@cyberint.com bounced)` | Bounced — no working contact |  |
| Cyble | US / intl | Email | `dpo@cyble.com` | Request sent — awaiting reply |  |
| Cyjax | UK | Email | `privacy@cyjax.com` | Request sent — awaiting reply |  |
| DarkInvader | UK | Email | `(privacy@darkinvader.io bounced)` | Bounced — no working contact |  |
| DarkOwl | US / intl | Email | `privacy@darkowl.com` | Request sent — awaiting reply |  |
| FalconFeeds | IN | Email | `support@falconfeeds.io` | Request sent — awaiting reply |  |
| Flare | CA | Email | `privacy@flare.io` | Request sent — awaiting reply |  |
